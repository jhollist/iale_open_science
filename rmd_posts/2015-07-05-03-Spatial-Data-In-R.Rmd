...
- [Exercise 1](#exercise-1): Convert Shapefiles into SP objects and display them
- [Exercise 2](#exercise-2): Convert GeoTiff to raster and 
...
- We can plot our current location
- The simplest method is to use base graphics.  Not very interesting but easy.
...
#export cropped NLCD as geotiff
  writeRaster(NLCDpdx, filename="../files/NLCDpdx.tif", format="GTiff", overwrite=TRUE)
```
...
- We can use the "values" function to look at the raster data categories but it is not very informative
